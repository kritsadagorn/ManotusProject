      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {members.map((member, index) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-t from-brown-400 via-yellow-800 to-transparent opacity-20"></div>
              <img
                src={member.image}
                alt={member.name}
